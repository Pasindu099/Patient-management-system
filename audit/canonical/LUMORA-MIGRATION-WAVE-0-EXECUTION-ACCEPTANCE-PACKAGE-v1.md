...
| W0-G12 Approval | PASS - OWNER DECISION | Technical approval: Pasindu Perera; data approval: Dr Amitha Perera, identified in follow-up reference `W0-APPROVER-IDENTITIES-2026-09-19`. Explicit acceptance is in decision reference `W0-OWNER-DECISION-2026-09-19` (SHA-256 below). The original decision timestamp was not supplied. |
...
- Named approver reference: `W0-APPROVER-IDENTITIES-2026-09-19`, the owner's follow-up message identifying **Pasindu Perera** for technical approval and **Dr Amitha Perera** for data approval. This identifies the approvers for the acceptance decision; it does not supply an independent approval timestamp or signature.
...
- Approval record date: 19 September 2026. The original decision time was not supplied. The acceptance decision was recorded in this package at 21:04 UTC, and the named approvers were added at 21:13 UTC on 19 September 2026. These are **recorded-at times**, not claimed decision times. Append the original decision time by reference if supplied; do not infer it from the repository or CI logs.
