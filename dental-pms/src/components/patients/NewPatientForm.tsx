...
import { cn, ACTIVE_PATIENT_LANGUAGES, MEDICAL_CHECKS } from '@/lib/utils'
    ...
    <div className="section-card">
            ...
            <div key={s.id} className="flex items-center flex-1 last:flex-none">
              ...
              <button
                ...
                className={cn(
                  ...
                  'text-sm font-bold border-2 transition-all flex-shrink-0',
                  step === s.id
      ...
      <form
        ...
        onKeyDown={e => {
          ...
          // only the "Register patient" button on the final step should.
